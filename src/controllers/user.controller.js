...
const signIn = async (req , res , next) => {
    ...
    try {
        ...
        return res.status(201).json({success: true , message: "User signed In successfully" , data: user}) ; 
    } catch (error) {
...
const signUp = async (req , res) => {
    try {
        ...
        console.log('Us ' , username , email , password);
        ...
        return res.status(200).json({success: true , message: 'User created Succesfully' , data: user}) ; 
